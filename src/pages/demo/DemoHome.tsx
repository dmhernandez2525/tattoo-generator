    ...
    <Layout className="flex flex-col items-center justify-start min-h-[80vh] py-8">
      ...
      <div className="max-w-4xl w-full text-center space-y-12 animate-in fade-in slide-in-from-bottom-5 duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          <Link to="/demo/generator" className="block">
          ...
          <Link to="/demo/machine" className="block">
        ...
        {/* Gallery Link */}
        <Link to="/demo/gallery" className="block">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {popularDesigns.map((design) => (
              <Link key={design.id} to={`/demo/design/${design.id}`}>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {stylePresets.map((preset) => (
              <Link key={preset.id} to={`/demo/generator?style=${preset.style}`}>
                <Button
                  variant="outline"
